...
int loadingData(vector<Adresat> &adresaci, int idZalogowanegoUzytkownika) {
    adresaci.clear();
    string name= "";
    string surname= "";
    string phone= "";
...
void changingData(vector<Adresat> &adresaci, int idZalogowanegoUzytkownika, int iloscUzytkownikow) {
    vector<string>daneOsobowe;
    ...
    for (int k=0; k<daneOsobowe.size(); k++) {
        ...
        if ((k<adresaci[kom].id)||(k>adresaci[kom].id)) {
            lista2.open("Adresaci_tymczasowy.txt",ios::out | ios::app);
            lista2 << daneOsobowe[k] << endl;
            lista2.close();
        } else {
            lista2.open("Adresaci_tymczasowy.txt",ios::out | ios::app);
            lista2 << adresaci[kom].id << "|";
            lista2 << adresaci[kom].userId << "|";
            lista2 << adresaci[kom].name << "|";
            lista2 << adresaci[kom].surname << "|";
            lista2 << adresaci[kom].phone << "|";
            lista2 << adresaci[kom].email << "|";
            lista2 << adresaci[kom].address << "|"<< endl;
            lista2.close();
        }
    }
    daneOsobowe.clear();
    ...
    while(1) {
        if(idZalogowanegoUzytkownika==0) {
            ...
            if (wybor=='1') {
                ...
                iloscUzytkownikow = loadingData(adresaci, idZalogowanegoUzytkownika);
            } else if (wybor=='9') {
            exit(0);
        }
        ...
        if (wybor2=='1') {
            ...
            changingData(adresaci, idZalogowanegoUzytkownika, iloscUzytkownikow);
            remove( "KsiazkaAdresow.txt" );
            rename( "Adresaci_tymczasowy.txt", "KsiazkaAdresow.txt" );
        } else if (wybor2=='7') {
